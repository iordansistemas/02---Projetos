...
if ($method === 'POST') {
    ...
    // NOVA TRAVA: Detecta erro de limite de tamanho de upload do PHP
    if (empty($_POST) && isset($_SERVER['CONTENT_LENGTH']) && $_SERVER['CONTENT_LENGTH'] > 0) {
        sendJsonResponse(['success' => false, 'message' => 'A imagem selecionada é muito pesada (Limite do servidor excedido). Reduza o tamanho da foto e tente novamente.'], 400);
    }
